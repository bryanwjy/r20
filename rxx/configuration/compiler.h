...
#if defined(__EDG__)
#  define RXX_COMPILER_EDG
#  define RXX_COMPILER_EDG_AT_LEAST(VERSION, REVISION) \
      (__EDG_VERSION__ >= RXX_CONCAT(VERSION, REVISION))
#  define RXX_COMPILER_TAG RXX_CONCAT(EDG, __EDG_VERSION__)
